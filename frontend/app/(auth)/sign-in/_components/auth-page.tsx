...
export function AuthPage() {
	return (
		<main className="relative md:h-screen md:overflow-hidden lg:grid lg:grid-cols-2">
			<div className="relative hidden h-full flex-col border-r bg-black p-10 lg:flex dark:bg-secondary/20">
				<div className="absolute inset-0 bg-gradient-to-b from-transparent via-transparent to-black" />
				<Logo className="mr-auto h-5 text-white" />
			...
			<div className="relative flex min-h-screen flex-col justify-center p-4 bg-black text-white">
				<div
					aria-hidden
				...
				<Button asChild className="absolute top-7 left-5 hover:bg-primary hover:text-white transition-all duration-300 " variant="ghost">
					<Link href="/">
						<ChevronLeftIcon />
						Home
					</Link>
